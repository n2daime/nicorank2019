...
└── nicorankLib/
    ...
    ├── Analyze/Official/ UnitTestRankingHistorySoHistory(10)
...
| `UnitTestRankingHistorySoHistory` | 10 | SoHistory作成・最新行移行・保持境界prune・Movie廃止・冪等・索引作成・CheckSoMovieNeedSabunのフォールバック/優先/null/表なし（Issue #31） |
