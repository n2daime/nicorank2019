...
└── nicorankLib/
    ...
    ├── Analyze/Official/ UnitTestRankingHistorySoHistory(12)
...
| `UnitTestRankingHistorySoHistory` | 12 | SoHistory作成・最新行移行・保持境界prune・Movie廃止・冪等・索引作成・CheckSoMovieNeedSabunのフォールバック/優先/null/表なし・日次更新の足し替えとまとめ消し（Issue #31） |
